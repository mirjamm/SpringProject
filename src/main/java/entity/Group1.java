...
@NamedQueries({
    ...
    , @NamedQuery(name = "Group1.findByGroupcode", query = "SELECT g FROM Group1 g WHERE g.groupcode = :groupcode")
...
public class Group1 implements Serializable {
    ...
    public String toString() {
        return "com.mycompany.attendanceapp.entities.Group1[ id=" + id + " ]";
    }
