...
@NamedQueries({
    ...
    , @NamedQuery(name = "Course.findByLectureship", query = "SELECT c FROM Course c WHERE c.lectureship = :lectureship")})
public class Course implements Serializable {
    ...
    public String toString() {
        return "com.mycompany.attendanceapp.entities.Course[ id=" + id + " ]";
    }
